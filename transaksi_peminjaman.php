...
if (isset($_GET['pinjam'])) {
    ...
    if ($b && $b['jumlah_buku'] > 0) {
        ...
        echo "<script>alert('Buku berhasil dipinjam');window.location='dashboard_costumer.php?halaman=transaksi';</script>";
        exit;
    } else {
        ...
        <table class="table table-hover mb-0 align-middle">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($b['jumlah_buku'] > 0): ?>
                            <a href="dashboard_costumer.php?halaman=transaksi&pinjam=<?= urlencode($b['judul_buku']) ?>" 
